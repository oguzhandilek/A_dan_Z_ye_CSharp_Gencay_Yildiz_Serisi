...
//0nModeLCreating metodu içerisinde Entity fonksiyonundan sonra çağrıulan HasData fonksiyonu ilgili entitye karşılık Seed Data 'ları eklememizi sağlayan bir fonksiyondur.
...
//İLişkiseL senaryolarda dependent tabLe'a veri eklerken Çoreign key kolonunun propertysi varsa eğer ona ilişkisel değerini vererek ekleme işlemini yapıyoruz.
#endregion

#region Seed Datanın Prımary Key' ını Degıştırme
//Eğer ki migrate edilen herhangi bir seed datanın sonrasında PK' i değiştirilirse bu datayla varsa ilişkisel başka veriler onlara cascade davranışı sergilenecektir.l
#endregion
...
public class ApplicationDbContext:DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Blog>()
            .HasData(
            new Blog() { Id = 1, Url = "albeyazimsoft.org" },
            new Blog() { Id = 2, Url = "karbeyazimsoft.org" }
            );

        modelBuilder.Entity<Post>()
            .HasData(
            //new Post() { Id = 1, BlogId = 1, Title = "A", Content = "..." },
            new Post() { Id = 11, BlogId = 1, Title = "A", Content = "..." },
